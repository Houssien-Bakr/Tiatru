                ...
                <?php foreach ($Similars as $Similar) { ?>
                    <div class="col">
                        <div class="list-movie">
                            <a href="<?php echo APP . '/' . $Similar['type'] . '/' . $Similar['self'] . '-' . $Similar['create_year']; ?>"
                                class="list-media">
                                            ...
                                            <div class="imdb">
                                                ...
                                                <svg x="0px" y="0px" width="36px" height="36px" viewBox="0 0 36 36">
                                                    <circle fill="none" stroke-width="1" cx="18" cy="18" r="16"
                                                        stroke-dasharray="<?php echo round($Similar['imdb'] / 10 * 100); ?> 100"
                                ...
                                <div class="media media-cover" data-src="<?php echo $Similar['image']; ?>">
                                    <?php if ($Similar['mpaa']) { ?>
                                        <div class="media-cover mpaa"><?php echo $Similar['mpaa']; ?></div><?php } ?>
                                </div>
                            </a>
                            <div class="list-caption">
                                ...
                                <div class="list-year" style="display:inline">
                                    <?php if ($Similar['create_year']) { ?>            <?php echo $Similar['create_year']; ?>        <?php } ?>
                                    <div class="mpaa float-right" style="display:inline;margin-top: 5px;">
                                        <?php echo ($Similar['type'] == 'movie' ? __('Movie') : __('Serie')); ?></div>
                                </div>
                            </div>
                        </div>
                    </div>
