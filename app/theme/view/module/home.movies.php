        ...
        foreach ($Newests as $Newest) {
            ...
            <div class="col">
                <div class="list-movie">
                    <a href="<?php if ($Newest['type'] == 'serie') {
                        echo APP . '/show/';
                    } else {
                        echo '/movie/';
                    }
                    echo $Newest['self'] . '-' . $Newest['create_year']; ?>"
                        class="list-media">
                                    ...
                                    <div class="imdb">
                                        ...
                                        <svg x="0px" y="0px" width="36px" height="36px" viewBox="0 0 36 36">
                                            <circle fill="none" stroke-width="1" cx="18" cy="18" r="16"
                                                stroke-dasharray="<?php echo round($Newest['imdb'] / 10 * 100); ?> 100"
                        ...
                        <div class="media media-cover" style="background-image:url('<?php echo $Newest['image']; ?>');">
                            <?php if ($Newest['mpaa']) { ?>
                                <div class="media-cover mpaa"><?php echo $Newest['mpaa']; ?></div><?php } ?>
                        </div>
                    </a>
                    <div class="list-caption">
                        ...
                        <?php } ?>    <?php if (!empty($Newest['end_year'])) { ?>
                            <div class="list-year"><?php echo $Newest['create_year']; ?> - <?php echo $Newest['end_year']; ?>
                            </div><?php } ?>
                    </div>
                </div>
            </div>
